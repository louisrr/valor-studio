...
`web::tls` tLS protocol operations.

[Standard library](standard-library/README.md) / [Web platform](standard-library/README.md#web-platform) / **TLS**

> **Source:** `stdlib/web/tls.valor` · **Routines:** 1 public · 1 internal
...
>
> ```valor
> @ result = web::tls::profile(web);
> ```

> ### SEE ALSO
>
> - [`web::tls::available`](#fn-available)
...
>
> ```valor
> bool result = web::tls::available();
> ```

> ### SEE ALSO
>
> - [`web::tls::profile`](#fn-profile)
...
[← Server-sent events](WEB-SSE-DOC.md) · [Table of contents](standard-library/README.md) · [WebAssembly →](WEB-WASM-DOC.md)
