...
`web::sse` server-sent event operations.

[Standard library](standard-library/README.md) / [Web platform](standard-library/README.md#web-platform) / **Server-sent events**

> **Source:** `stdlib/web/sse.valor` · **Routines:** 1 public · 1 internal
...
>
> ```valor
> @ result = web::sse::profile(web);
> ```

> ### SEE ALSO
>
> - [`web::sse::available`](#fn-available)
...
>
> ```valor
> bool result = web::sse::available();
> ```

> ### SEE ALSO
>
> - [`web::sse::profile`](#fn-profile)
...
[← QUIC](WEB-QUIC-DOC.md) · [Table of contents](standard-library/README.md) · [TLS →](WEB-TLS-DOC.md)
