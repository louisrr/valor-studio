...
`web::grpc` gRPC protocol operations.

[Standard library](standard-library/README.md) / [Web platform](standard-library/README.md#web-platform) / **gRPC**

> **Source:** `stdlib/web/grpc.valor` · **Routines:** 1 public · 1 internal
...
>
> ```valor
> @ result = web::grpc::profile(web);
> ```

> ### SEE ALSO
>
> - [`web::grpc::available`](#fn-available)
...
>
> ```valor
> bool result = web::grpc::available();
> ```

> ### SEE ALSO
>
> - [`web::grpc::profile`](#fn-profile)
...
[← JSON](WEB-JSON-DOC.md) · [Table of contents](standard-library/README.md) · [QUIC →](WEB-QUIC-DOC.md)
