...
`web` web runtime profile and initialization.

[Standard library](standard-library/README.md) / [Web platform](standard-library/README.md#web-platform) / **Web profile**

> **Source:** `stdlib/web.valor` · **Routines:** 0 public · 2 internal
...
>
> ```valor
> @ result = web::profile(web);
> ```

> ### SEE ALSO
>
> - [`web::available`](#fn-available)
...
> *Internal API*
>
> Provides the module's **available** operation. Returns `pub bool`.
...
>
> ```valor
> pub bool result = web::available();
> ```

> ### SEE ALSO
>
> - [`web::profile`](#fn-profile)
...
[← Cryptographic hashing](STD-CRYPTO-HASH-DOC.md) · [Table of contents](standard-library/README.md) · [Web async →](WEB-ASYNC-DOC.md)
