...
`web::wasm` webAssembly integration.

[Standard library](standard-library/README.md) / [Web platform](standard-library/README.md#web-platform) / **WebAssembly**

> **Source:** `stdlib/web/wasm.valor` · **Routines:** 1 public · 1 internal
...
>
> ```valor
> @ result = web::wasm::profile(web);
> ```

> ### SEE ALSO
>
> - [`web::wasm::available`](#fn-available)
...
>
> ```valor
> bool result = web::wasm::available();
> ```

> ### SEE ALSO
>
> - [`web::wasm::profile`](#fn-profile)
...
[← TLS](WEB-TLS-DOC.md) · [Table of contents](standard-library/README.md) · [WebSockets →](WEB-WS-DOC.md)
